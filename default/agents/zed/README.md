...
- **备用模型**：GLM 5.3 / GLM 5.3 Flash（z.ai，OpenAI-compatible）、DeepSeek V4 Flash / V4 Pro（原生 provider 内置）、MiMo 2.5 系列（OpenAI-compatible）、Kimi K3 / K2.7 Code / K2.6（Kimi，OpenAI-compatible）
